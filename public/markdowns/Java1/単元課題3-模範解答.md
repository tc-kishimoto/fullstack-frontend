...
import jp.co.example.pet.Animal;
import jp.co.example.pet.Cat;
import jp.co.example.pet.Dog;
import jp.co.example.pet.Lizard;
import jp.co.example.pet.Pet;
import jp.co.example.pet.Reptile;
import jp.co.example.servlet.PetSessionInfo;
...
import jp.co.example.util.PetUtil;
