...
'mail' => string 'alice@test.co.jp' (length=16) 2 => string 'alice@test.co.jp' (length=16) 
'pass' => string 'test' (length=4) 3 => string 'test' (length=4)
```
...
```text
array (size=6)
 0 => array (size=8) 'id' => string '1' (length=1) 0 => string '1' (length=1) 'name' => string 'Alice' (length=5) 1 => string 'Alice' (length=5) 'mail' => string 'alice@test.co.jp' (length=16) 2 => string 'alice@test.co.jp' (length=16) 'pass' => string 'test' (length=4) 3 => string 'test' (length=4) 
1 => array (size=8) 'id' => string '2' (length=1) 0 => string '2' (length=1) 'name' => string 'Bob' (length=3) 1 => string 'Bob' (length=3) 'mail' => string 'bob@test.co.jp' (length=14) 2 => string 'bob@test.co.jp' (length=14) 'pass' => string 'test' (length=4) 3 => string 'test' (length=4)
```
...
'mail' => string 'alice@test.co.jp' (length=16) 
...
```text
Error: Call to a member function fetch() on bool in /Applications/MAMP/htdocs/example-php/demo/db1.php on line 107
```
...
```text
PDOException: SQLSTATE[42S22]: Column not found: 1054 Unknown column 'i' in 'where clause' in /Applications/MAMP/htdocs/example-php/demo/db1.php on line 106
```
